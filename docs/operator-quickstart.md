# Operator Quickstart — Other Residential Care Activities

Shortest path from clone to a verified local dry-run for **ISIC 879** (`cloud-itonami-isic-879`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-879.git
cd cloud-itonami-isic-879
```
...
- Blueprint governor key: `rescare-governor`
- Likely source path: `rescare.governor.cljc`
